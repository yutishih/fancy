...
import Product8 from '../Carousels/CarouselImgs/product-8.png'
import Product9 from '../Carousels/CarouselImgs/product-9.png'
import Product10 from '../Carousels/CarouselImgs/product-10.png'
import Product11 from '../Carousels/CarouselImgs/product-11.png'
import Product13 from '../Carousels/CarouselImgs/product-13.png'
import Product14 from '../Carousels/CarouselImgs/product-14.png'
import Product15 from '../Carousels/CarouselImgs/product-15.png'
import Product16 from '../Carousels/CarouselImgs/product-16.png'
import Product17 from '../Carousels/CarouselImgs/product-17.png'
import Product18 from '../Carousels/CarouselImgs/product-18.png'
    ...
    return (
      <Carousel
        ...
        beforeChange={nextSlide => {
          if (nextSlide !== 0 && this.state.additionalTransfrom !== 300) {
            this.setState({ additionalTransfrom: 300 });
          }
          if (nextSlide === 0 && this.state.additionalTransfrom === 300) {
            this.setState({ additionalTransfrom: 0 });
          }
